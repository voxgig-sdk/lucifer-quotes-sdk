...
#      offline in seeded test mode (LuciferQuotesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "LuciferQuotes_sdk.rb")
  SDK_CLASS = "LuciferQuotesSDK"
