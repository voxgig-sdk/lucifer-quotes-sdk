...
// LuciferQuotes SDK utility: graphql
//
...
class LuciferQuotesGraphql
{
    ...
    // equivalent.
    public static function body(LuciferQuotesContext $ctx): mixed
    {
    ...
    public static function errors(LuciferQuotesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
