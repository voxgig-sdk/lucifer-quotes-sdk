...
// LuciferQuotes SDK utility: fetcher

class LuciferQuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LuciferQuotesSDK/1.0)';
    ...
    public static function call(LuciferQuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
