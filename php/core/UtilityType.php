...
// LuciferQuotes SDK utility type

class LuciferQuotesUtility
{
    ...
    public static function copy(LuciferQuotesUtility $src): LuciferQuotesUtility
    {
        $u = new LuciferQuotesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
