...
// LuciferQuotes SDK netsim feature
...
class LuciferQuotesNetsimFeature extends LuciferQuotesBaseFeature
{
    ...
    private function _simulate(LuciferQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LuciferQuotesContext $ctx, array $applied): void
    {
        $client = $this->client;
