...
// LuciferQuotes SDK rbac feature
...
class LuciferQuotesRbacFeature extends LuciferQuotesBaseFeature
{
    ...
    private function _required(LuciferQuotesContext $ctx): ?string
    {
    ...
    private function _reject(LuciferQuotesContext $ctx, string $required): void
    {
    ...
    private function _track(LuciferQuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
