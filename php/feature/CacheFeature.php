...
// LuciferQuotes SDK cache feature
...
class LuciferQuotesCacheFeature extends LuciferQuotesBaseFeature
{
    ...
    private function _through(LuciferQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
