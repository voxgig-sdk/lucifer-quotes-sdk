...
// LuciferQuotes SDK audit feature
...
class LuciferQuotesAuditFeature extends LuciferQuotesBaseFeature
{
    ...
    private function _emit(LuciferQuotesContext $ctx, string $outcome): void
    {
