...
// LuciferQuotes SDK timeout feature
...
class LuciferQuotesTimeoutFeature extends LuciferQuotesBaseFeature
{
    ...
    private function _with_timeout(LuciferQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LuciferQuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
