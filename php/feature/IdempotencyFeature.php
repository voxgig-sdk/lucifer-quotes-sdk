...
// LuciferQuotes SDK idempotency feature
...
class LuciferQuotesIdempotencyFeature extends LuciferQuotesBaseFeature
{
    ...
    private function _mutating(LuciferQuotesContext $ctx): bool
    {
