...
// LuciferQuotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LuciferQuotesSDK::test)
...
{
    private const SDK_CLASS = 'LuciferQuotesSDK';
    ...
    private const SDK_BASE = 'luciferquotes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../luciferquotes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
