...
// LuciferQuotes SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LuciferQuotesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LuciferQuotesOmni::structfix($now, Struct::undef()))
                        !== json_encode(LuciferQuotesOmni::structfix($val, Struct::undef()))) {
