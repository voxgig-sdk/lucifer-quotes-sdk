...
function runner.env_override(m)
  local live = runner.getenv("LUCIFERQUOTES_TEST_LIVE")
  local override = runner.getenv("LUCIFERQUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LUCIFERQUOTES_TEST_EXPLAIN")
