...
function runner.env_override(m)
  local live = runner.getenv("LUCIFER_QUOTES_TEST_LIVE")
  local override = runner.getenv("LUCIFER_QUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LUCIFER_QUOTES_TEST_EXPLAIN")
