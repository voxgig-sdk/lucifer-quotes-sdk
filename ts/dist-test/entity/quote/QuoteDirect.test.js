...
(0, node_test_1.describe)('QuoteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.LuciferQuotesSDK({
...
function liveScenariosActive() { return false && process.env.LUCIFER_QUOTES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LuciferQuotesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['LUCIFER_QUOTES_TEST_QUOTE_ENTID'];
    ...
    const client = new __1.LuciferQuotesSDK({
        base: 'http://localhost:8080',
