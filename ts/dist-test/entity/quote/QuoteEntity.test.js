...
(0, node_test_1.describe)('QuoteEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('LUCIFER_QUOTES_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.LuciferQuotesSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set LUCIFER_QUOTES_TEST_QUOTE_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != quote_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    let client = __1.LuciferQuotesSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['LUCIFER_QUOTES_TEST_QUOTE_ENTID'];
    ...
    if (live) {
        client = new __1.LuciferQuotesSDK(merge([
