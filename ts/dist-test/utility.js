...
function envOverride(m) {
    if ('TRUE' === process.env.LUCIFER_QUOTES_TEST_LIVE ||
        'TRUE' === process.env.LUCIFER_QUOTES_TEST_OVERRIDE) {
    ...
    m.LUCIFER_QUOTES_TEST_EXPLAIN = process.env.LUCIFER_QUOTES_TEST_EXPLAIN || m.LUCIFER_QUOTES_TEST_EXPLAIN;
    return m;
}
