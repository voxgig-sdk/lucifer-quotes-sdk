...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.LUCIFERQUOTES_TEST_LIVE ||
    'TRUE' === process.env.LUCIFERQUOTES_TEST_OVERRIDE
  ) {
  ...
  m.LUCIFERQUOTES_TEST_EXPLAIN = process.env.LUCIFERQUOTES_TEST_EXPLAIN || m.LUCIFERQUOTES_TEST_EXPLAIN
