...
AQL-driven CLI and REPL for the LuciferQuotes SDK. Positional arguments are
...
./lucifer-quotes-cli list quote
./lucifer-quotes-cli load 1 quote
./lucifer-quotes-cli load '{id:1}' quote
