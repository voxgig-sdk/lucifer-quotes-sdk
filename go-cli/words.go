...
func registerSDKWords(r *eng.Registry, client *sdk.LuciferQuotesSDK) {
...
func runOp(client *sdk.LuciferQuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
