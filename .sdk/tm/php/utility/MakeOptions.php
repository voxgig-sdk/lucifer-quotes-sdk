...
// LuciferQuotes SDK utility: make_options

class LuciferQuotesMakeOptions
{
    ...
    public static function call(LuciferQuotesContext $ctx): array
    {
        ...
        //
        // `LuciferQuotesSchema::optspec()` is built from the model:
        ...
        $optspec = LuciferQuotesSchema::optspec();
