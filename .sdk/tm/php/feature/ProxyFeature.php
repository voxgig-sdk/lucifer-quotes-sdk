...
// LuciferQuotes SDK proxy feature
...
class LuciferQuotesProxyFeature extends LuciferQuotesBaseFeature
{
    ...
    public function init(LuciferQuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LuciferQuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
