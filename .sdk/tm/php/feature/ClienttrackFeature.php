...
// LuciferQuotes SDK clienttrack feature
...
class LuciferQuotesClienttrackFeature extends LuciferQuotesBaseFeature
{
    ...
    public function PostConstruct(LuciferQuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LuciferQuotes-SDK';
