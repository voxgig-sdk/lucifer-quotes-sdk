...
// LuciferQuotes SDK streaming feature
...
class LuciferQuotesStreamingFeature extends LuciferQuotesBaseFeature
{
    ...
    private function _iterate(LuciferQuotesResult $result): \Generator
    {
    ...
    private function _streamable(LuciferQuotesContext $ctx): bool
    {
