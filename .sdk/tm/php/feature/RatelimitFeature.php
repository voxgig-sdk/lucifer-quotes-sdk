...
// LuciferQuotes SDK ratelimit feature
...
class LuciferQuotesRatelimitFeature extends LuciferQuotesBaseFeature
{
    ...
    private function _acquire(LuciferQuotesContext $ctx): void
    {
    ...
    private function _track(LuciferQuotesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
