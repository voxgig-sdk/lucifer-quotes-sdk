...
class LuciferQuotesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LuciferQuotesTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = LuciferQuotesTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = LuciferQuotesTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
