...
class LuciferQuotesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LuciferQuotesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LuciferQuotesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LuciferQuotesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
