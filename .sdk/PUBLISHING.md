...
|---|---|---|
| `ts/` | @voxgig-sdk/lucifer-quotes-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/lucifer-quotes-sdk \
      --repository voxgig-sdk/lucifer-quotes-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/lucifer-quotes-sdk` shows it, and
`npm trust revoke @voxgig-sdk/lucifer-quotes-sdk --id=<id>` removes it.
