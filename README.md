...
This is an unofficial SDK for the Lucifer Quotes public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/lucifer-quotes` | `npm install @voxgig-sdk/lucifer-quotes` |
| Python | `voxgig-sdk-lucifer-quotes` | `pip install voxgig-sdk-lucifer-quotes` |
| PHP | `voxgig-sdk/lucifer-quotes` | `composer require voxgig-sdk/lucifer-quotes` |
| Golang | `github.com/voxgig-sdk/lucifer-quotes-sdk/go` | `go get github.com/voxgig-sdk/lucifer-quotes-sdk/go` |
| Ruby | `voxgig-sdk-lucifer-quotes` | `gem install voxgig-sdk-lucifer-quotes` |
| Lua | `voxgig-sdk-lucifer-quotes` | `luarocks install voxgig-sdk-lucifer-quotes` |
