...
This API provides random quotes from the character Lucifer Morningstar and other show characters.

Learn more about Lucifer Quotes API at [lucifer-quotes.vercel.app](https://lucifer-quotes.vercel.app).
...
| --- | --- | --- |
| **Quote** | The Quote entity (load). | `/api/quotes` |
