// Command LuciferQuotes-mcp is an MCP server exposing the LuciferQuotes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	LuciferQuotes_list  — list records of an entity
//	LuciferQuotes_load  — load a single record of an entity
//
