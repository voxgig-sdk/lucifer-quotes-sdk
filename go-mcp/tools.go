...
func registerTools(server *mcp.Server, client *sdk.LuciferQuotesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "lucifer-quotes_list",
		Description: "List records from LuciferQuotes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "lucifer-quotes_load",
		Description: "Load a single record from LuciferQuotes. " +
...
func runOp(client *sdk.LuciferQuotesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.LuciferQuotesSDK, name string) (sdk.LuciferQuotesEntity, error) {
