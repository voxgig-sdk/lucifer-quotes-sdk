...
Results: Successful response with quote(s).
...
| --- | --- | --- | --- |
| Quote | `load` | `GET /api/quotes` | See reference |

## Connect to the API

- Production server: `https://lucifer-quotes.vercel.app`
...
- `lucifer-quotes_list`: List records for an entity. No active entity supports this operation.
- `lucifer-quotes_load`: Load one record for an entity. Supported entities: `quote`.
