...
from luciferquotes_sdk.core.helpers import get_ctx_prop, to_map
...
class LuciferQuotesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = LuciferQuotesControl()
        ...
        if isinstance(sp, LuciferQuotesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LuciferQuotesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LuciferQuotesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return LuciferQuotesError(code, msg, self)
