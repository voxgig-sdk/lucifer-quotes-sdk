...
from luciferquotes_sdk.utility import register

# Load features
from luciferquotes_sdk.feature.base_feature import LuciferQuotesBaseFeature
from luciferquotes_sdk.features import _has_feature, _make_feature
...
class LuciferQuotesSDK:
    ...
    def get_utility(self):
        return LuciferQuotesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("LuciferQuotesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Quote(self, data=None) -> "QuoteEntity":
        ...
        from luciferquotes_sdk.entity.quote_entity import QuoteEntity
        return QuoteEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "LuciferQuotesSDK":
        if sdkopts is None:
            sdkopts = {}
