# LuciferQuotes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LuciferQuotesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LuciferQuotesSDK(...) and LuciferQuotesSDK.test(...) become
#      LuciferQuotesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "luciferquotes_sdk"
_SDK_CLASS = "LuciferQuotesSDK"
