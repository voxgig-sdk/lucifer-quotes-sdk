...
class LuciferQuotesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LuciferQuotesTestRunner.getenv("LUCIFERQUOTES_TEST_LIVE")
        override = LuciferQuotesTestRunner.getenv("LUCIFERQUOTES_TEST_OVERRIDE")
        ...
        explain = LuciferQuotesTestRunner.getenv("LUCIFERQUOTES_TEST_EXPLAIN")
